  ...
  return (
    <div className="tokenomics-container" id="tokenomics">
      <div className="tokenomics-container2">
        <div className="tokenomics-container-inner">
          <div className="tokenomics--left">
            ...
            <div
              ...
              data-aos-easing="ease-in-out"
            >
              $DAYLIGHT is an elastic supply token that runs on the Avalanche
              chain and rewards holders through conventional, sustained positive
              rebases, with an APY of 160,589.28%. Interest rewards are
              compounded every 30 minutes for every web3 wallet holding any
              $DAYLIGHT tokens.
            </div>
            <Button
              data-aos="fade-right"
